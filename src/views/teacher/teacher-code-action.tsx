...
export const TeacherCodeAction = forwardRef(
    ({ onSubmit, setStdInput, stdInput }: TeacherCodeActionProps, ref: any) => {
        ...
        return (
            <div className='relative flex gap-x-4 max-h-fit h-fit mx-2 rounded-lg p-2 bg-slate-100 transition-all'>
                <div className='grow font-roboto '>
                    <p className=' text-sm tracking-wide p-1'>Output</p>
                    <div className='text-sm p-2 h-52  overflow-y-scroll text-white font-mono rounded-md bg-gray-900'>
